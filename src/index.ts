...
/**
 * Romanian Data Protection MCP — stdio entry point.
 *
 * Provides MCP tools for querying ANSPDCP decisions, sanctions, and
...
const SERVER_NAME = "romanian-data-protection-mcp";

// --- Tool definitions ---------------------------------------------------------

const TOOLS = [
  {
    name: "ro_dp_search_decisions",
    description:
    ...
    inputSchema: {
      ...
      properties: {
        query: {
          type: "string",
          description: "Search query in Romanian or English (e.g., 'UniCredit date personale', 'videomonitorizare', 'consimtamant')",
        },
        type: {
          type: "string",
          enum: ["sanction", "warning", "decision", "opinion"],
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        reference: {
          type: "string",
          description: "ANSPDCP decision reference (e.g., 'ANSPDCP-2019-001', 'ANSPDCP-2022-015')",
        },
      },
      required: ["reference"],
    },
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        query: {
          type: "string",
          description: "Search query in Romanian or English (e.g., 'videomonitorizare', 'DPIA', 'cookies consimtamant')",
        },
        type: {
          type: "string",
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        id: {
          type: "number",
          description: "Guideline database ID (from ro_dp_search_guidelines results)",
        },
      },
      required: ["id"],
    },
...
const SearchDecisionsArgs = z.object({
  ...
  type: z.enum(["sanction", "warning", "decision", "opinion"]).optional(),
    ...
    switch (name) {
      ...
      case "ro_dp_about": {
        return textContent({
          ...
          version: pkgVersion,
          description:
            "ANSPDCP (Autoritatea Națională de Supraveghere a Prelucrării Datelor cu Caracter Personal — Romanian Data Protection Authority) MCP server. Provides access to Romanian data protection authority decisions, sanctions, warnings, and official guidance documents.",
          data_source: "ANSPDCP (https://www.dataprotection.ro/)",
          coverage: {
            decisions: "ANSPDCP sanctions, warnings, and administrative decisions",
            guidelines: "ANSPDCP guidelines, opinions, recommendations, and FAQs",
            topics: "Consent, cookies, transfers, DPIA, breach notification, privacy by design, videomonitorizare (CCTV), health data, children",
          },
