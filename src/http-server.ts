...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across ANSPDCP decisions (sanctions, reprimands, and administrative decisions). Returns matching decisions with reference, entity name, fine amount, and GDPR articles cited.",
    inputSchema: {
  ...
  },
  {
    ...
    description:
      "Get a specific ANSPDCP decision by reference number (e.g., 'ANSPDCP-2022-001').",
    inputSchema: {
      type: "object" as const,
      properties: {
        reference: { type: "string", description: "ANSPDCP decision reference" },
      },
      required: ["reference"],
    },
  },
  {
    ...
    description:
      "Search ANSPDCP guidance documents: guidelines, opinions, recommendations, and circulars.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description: "Get a specific ANSPDCP guidance document by its database ID.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description: "List all covered data protection topics with Romanian and English names.",
      ...
      switch (name) {
        ...
        case "ro_dp_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "ANSPDCP (Hellenic Data Protection Authority) MCP server. Provides access to Romanian data protection authority decisions, sanctions, reprimands, and official guidance documents.",
