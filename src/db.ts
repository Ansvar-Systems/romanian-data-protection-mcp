/**
 * SQLite database access layer for the ANSPDCP MCP server.
 *
 * Schema:
 *   - decisions    — ANSPDCP decisions, sanctions, and reprimands
 *   - guidelines   — ANSPDCP guidance documents, opinions, and recommendations
