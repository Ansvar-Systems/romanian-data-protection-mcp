...
**Endpoint:** `https://mcp.ansvar.eu/romanian-data-protection/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add romanian-data-protection-mcp --transport http https://mcp.ansvar.eu/romanian-data-protection/mcp` |
...
```json
{
  "mcpServers": {
    "romanian-data-protection-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/romanian-data-protection/mcp"
    }
  }
}
```
